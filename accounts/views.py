...
class SignUpView(GuestOnlyView, FormView):
    ...
    def form_valid(self, SignUpForm):
        ...
        if settings.ENABLE_USER_ACTIVATION:
            ...
            raw_password = SignUpForm.cleaned_data['password1']
...
#
#     def get_initial(self):
#         # pro = self.request.Profile()
#         pro = Profile()
#         initial = super().get_initial()
#         initial['age'] = pro.age
#         initial['gender'] = pro.gender
#         initial['bio'] = pro.bio
#         initial['employment'] = pro.employment
#         initial['location'] = pro.location
#         initial['language'] = pro.language
#
#         return initial
#
#     def form_valid(self, form):
#         pro = Profile()
#         pro.age = form.cleaned_data['age']
#         pro.gender = form.cleaned_data['gender']
#         pro.bio = form.cleaned_data['bio']
#         pro.employment = form.cleaned_data['employment']
#         pro.location = form.cleaned_data['location']
#         pro.language = form.cleaned_data['language']
#         if form.is_valid():
#             form.save()
#             messages.success(self.request, _('You are successfully changed your profile'))
